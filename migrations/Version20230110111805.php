 ...
 */
final class Version20230110111805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Product CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE name name VARCHAR(255) NOT NULL, CHANGE price price INT NOT NULL, ADD PRIMARY KEY (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE id id INT DEFAULT NULL, CHANGE name name VARCHAR(255) DEFAULT NULL, CHANGE price price INT DEFAULT NULL');
    }
}
